...
/*
1) Click On lead module.
2) Click on new create lead plus button.
3)Enter all the mandotory fields(*) and click on save button.
4)Lead number should be generated and displayed on lead information page.
5)click on edit button and enter the mobile & phone number after that click on save button.
6)click on leads module,list of all the generated lead should be displayed.
7)select the firstname from dropdown and in search box type the name and click on searchnow button.
8)Lead list page should be displayed and check mobile no is updated or not.
 */
