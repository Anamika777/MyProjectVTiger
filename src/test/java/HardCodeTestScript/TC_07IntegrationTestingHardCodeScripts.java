...
3)move the mouse cursor to more and click on FAQ it should display FAQ page.
4)click on create FAQ icon it should display creating new faq page.
5)Fill all the neccessary details(productname,question,answer,select status from dropdown) and click on save button.
6)click on home icon it should display home page.
7)check newly created faq should display on my recent faq in home page.
